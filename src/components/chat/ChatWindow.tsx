...
export function ChatWindow({
  ...
  const isCustomProvider =
    ...
    Boolean(selectedProvider && selectedProvider !== '__anthropic__')
  ...
  const { data: providerOverview } = useAiProviderOverview({
  ...
  const useAdaptiveThinkingFlag =
    ...
    supportsAdaptiveThinking(
      selectedModel,
      providerOverview?.providers.claude.version ?? null
    )
  ...
  const {
    ...
    createSession,
    resolveCustomProfile,
    cliVersion: providerOverview?.providers.claude.version ?? null,
    worktreeProjectId: worktree?.project_id,
  })
